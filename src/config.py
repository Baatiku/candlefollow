...
PAIR_CONSECUTIVE_LOSS_THRESHOLD = int(os.getenv("PAIR_CONSECUTIVE_LOSS_THRESHOLD", "5"))
PAIR_CONSECUTIVE_LOSS_PENALTY_MINUTES = int(os.getenv("PAIR_CONSECUTIVE_LOSS_PENALTY_MINUTES", "5"))
...
DRAWDOWN_RISK_PAUSE_SEC = float(os.getenv("DRAWDOWN_RISK_PAUSE_SEC", "0"))
