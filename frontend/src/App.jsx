...
function App() {
  ...
  const defaultBracketPresets = balanceTierBrackets.length > 0
    ...
    : [
        ...
        { label: '$2,000–$9,999 (Base $20)', val: [20, 60, 180, 500, 1600, 3600, 8040] },
        { label: '$10,000–$24,999 (Base $45)', val: [45, 135, 405, 1125, 3600, 8100, 18090] },
        { label: '$25,000+ (Base $100)', val: [100, 300, 900, 2500, 8000, 18000, 40200] },
      ];
